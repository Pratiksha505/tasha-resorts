    ...
    return(
        ...
        <div className="purpose4">
            <div className="home">
                ...
                <div data-aos="fade-right" data-aos-duration="3000" className="card mb-3" id="card7">
                ...
                <div data-aos="fade-left" data-aos-duration="3000" className="card mb-3" id="card8">
