...
function Home(){
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <li class="nav-item dropdown" id="t2">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Services
          </a>
          <ul className="dropdown-menu">
            <Link to="/Stay" id="dlist">
              <li className="dropdown-item" > STAY </li> 
            </Link>
            <Link to="/Dining" id="dlist">
              <li className="dropdown-item"> DINING </li> 
            </Link>
            <Link to="/Wedding" id="dlist">
              <li className="dropdown-item"> WEDDING </li> 
            </Link>
            <Link to="/Events" id="dlist">
      ...
      <a href="#contact" className="nav-item" id="tt">
       <li className="nav-item">Contact Us</li>
      </a>
      <Link to="/Admin">
        <button className="btn btn-outline-dark" id = "lbtn1" type="submit"> Admin </button>
      </Link>
      </ul>
    </div>
  </div>
  ...
  <div className="bottom">
    ...
    <div className="bott2">
      ...
      <ul className="quick">
        ...
        <Link className="l1" to="/Wedding"><li>Wedding</li></Link>
